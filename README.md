...
The PacBio raw data used in this study can be download [HERE](https://datacommons.cyverse.org/browse/iplant/home/moontree1985/analyses/bioprotocol/raw_Pacbio).
The download instruction can be found in the input folder.   
